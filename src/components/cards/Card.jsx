         ...
         <div className={estilos.info}>
            <div className={estilos.botones}>
               <div>
                  {
                     isFav ? (
                        <button onClick={handleFavorite} className={estilos.btnFav}><h1>❤️</h1></button>
                     ) : (
                        <button onClick={handleFavorite} className={estilos.btnFav}><h1>🤍</h1></button>
                     )
                  }
               </div>
               <div className={estilos.divButton}>
                  <button onClick={() => onClose(id)} className={estilos.button}>X</button>
               </div>
            </div>
            <h2>{name}</h2>
            <h2>{status}</h2>
