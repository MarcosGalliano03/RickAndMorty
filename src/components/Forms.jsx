            ...
            <div className={estilos.cartaForm}>
                ...
                <div className={estilos.divFormCarta}>
                    <form>
                        ...
                        {errors.password && <p className={estilos.error}>{errors.password}</p>}

                        <button type="submit" onClick={handleSubmit} className={estilos.btnForm}><h3 className={estilos.h3}>Submit</h3></button>
                    </form>
                </div>
            </div>
